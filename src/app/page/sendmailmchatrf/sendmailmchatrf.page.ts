...
@Component({
  selector: 'app-sendmailmchatrf',
  templateUrl: './sendmailmchatrf.page.html',
  styleUrls: ['./sendmailmchatrf.page.scss'],
})
export class SendmailmchatrfPage implements OnInit {
  Email: '';
  data: any
  ...
  Sendemail() {
    ...
    if (this.netWork.type.toUpperCase() != "NONE") {
      this.service.postAPIquestionCDC(this.service.getHost() + 'mchatr/answersheets/' + this.data.createdId + '/pdfToMail', body).subscribe
        (rs => {
