...
@Component({
  selector: 'app-sendmailasqguest',
  templateUrl: './sendmailasqguest.page.html',
  styleUrls: ['./sendmailasqguest.page.scss'],
})
export class SendmailasqguestPage {
  Email: '';
  data: any
  ...
  Sendemail() {
    ...
    if (this.netWork.type.toUpperCase() != "NONE") {
      this.service.postAPIquestionCDC(this.service.getHost() + 'asq/guest/answersheets/' + this.data.createdId + '/pdfToMail', body).subscribe
        (rs => {
