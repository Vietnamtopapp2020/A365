...
@Component({
  selector: 'app-sendmailmqol',
  templateUrl: './sendmailmqol.page.html',
  styleUrls: ['./sendmailmqol.page.scss'],
})
export class SendmailmqolPage implements OnInit {
  Email: '';
  data: any
  ...
  Sendemail() {
    ...
    if (this.netWork.type.toUpperCase() != "NONE") {
      this.service.postAPIquestionCDC(this.service.getHost() + 'qol/answersheets/' + this.data.createdId + '/pdfToMail', body).subscribe
        (rs => {
