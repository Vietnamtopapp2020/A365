...
@Component({
  selector: 'app-sendmailasq',
  templateUrl: './sendmailasq.page.html',
  styleUrls: ['./sendmailasq.page.scss'],
})
export class SendmailasqPage {
  Email: '';
  data: any
  ...
  Sendemail() {
    ...
    if (this.netWork.type.toUpperCase() != "NONE") {
      this.service.postAPIquestionCDC(this.service.getHost() + 'asq/answersheets/' + this.data.createdId + '/pdfToMail', body).subscribe
        (rs => {
