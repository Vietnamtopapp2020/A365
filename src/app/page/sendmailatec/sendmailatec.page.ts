...
@Component({
  selector: 'app-sendmailatec',
  templateUrl: './sendmailatec.page.html',
  styleUrls: ['./sendmailatec.page.scss'],
})
export class SendmailatecPage implements OnInit {
  Email: '';
  data: any
  ...
  Sendemail() {
    ...
    if (this.netWork.type.toUpperCase() != "NONE") {
      this.service.postAPIquestionCDC(this.service.getHost() + 'atec/answersheets/' + this.data.createdId + '/pdfToMail', body).subscribe
        (rs => {
