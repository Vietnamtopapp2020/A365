...
import { ModalController, NavController, BooleanValueAccessor, MenuController } from '@ionic/angular';
...
@Component({
  selector: 'app-createchildrenguest',
  templateUrl: './createchildrenguest.page.html',
  styleUrls: ['./createchildrenguest.page.scss'],
})
export class CreatechildrenguestPage implements OnInit {
  childrenlist = [];
  txtname = "";
  txtdob = "";
  sltGender = null;
  ...
  Creatchildren() {
    if (this.txtpregnantWeeks < 21 || this.txtpregnantWeeks > 45) {
    ...
    else if (this.sltIsDiagnosed != null && this.sltIsDiagnosed.isDiagnosed && (this.txtageWhenDiagnosed == undefined || this.sltScreenedOnA365 == null || this.sltDiagnosticConclusion == null || this.sltDiagnosticPlace == null || this.sltDiagnosticStaff == null)) {
      ...
      if (this.sltArea != null) {
        Area = this.sltArea.code;
      }
      if (this.sltDistrict != null) {
        district = this.sltDistrict.code;
      }
      if (this.sltTown != null) {
        ward = this.sltTown.code;
      }
      if (this.sltTown != null) {
        ward = this.sltTown.code;
      }
      ...
      var body = {
        "name": this.txtname,
        "dob": moment(this.txtdob).format("YYYY-MM-DDT00:00:00.000Z"),
        "gender": gender,
      ...
      if (this.netWork.type.toUpperCase() != "NONE") {
        this.service.postAPIquestionmchatR(this.service.getHost() + 'asq/guest/session', body).subscribe
          (result => {
            ...
            this.router.navigate(['/asqtest-guest'], navigationExtras);
          }, error => {
            if (this.service.CheckLoading) {
              this.service.CheckLoading = false;
              this.toast.DismissToast();
