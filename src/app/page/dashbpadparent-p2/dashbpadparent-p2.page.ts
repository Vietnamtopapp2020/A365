...
@Component({
  selector: 'app-dashbpadparent-p2',
  templateUrl: './dashbpadparent-p2.page.html',
  styleUrls: ['./dashbpadparent-p2.page.scss'],
})
export class DashbpadparentP2Page implements OnInit {
