...
@Component({
  selector: 'app-dashboadteacher',
  templateUrl: './dashboadteacher.page.html',
  styleUrls: ['./dashboadteacher.page.scss'],
})
export class DashboadteacherPage {
  page = "dashboadteacher";
  dc = [
    ...
    if (!data.checkSelect) {
      ...
      if (this.checkModal) {
        ...
        const myModal = await this.modalCtrl.create({
          component: DashbpadteacherP2Page,
          componentProps: {
