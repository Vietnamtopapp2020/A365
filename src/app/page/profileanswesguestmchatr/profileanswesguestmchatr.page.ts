...
@Component({
  selector: 'app-profileanswesguestmchatr',
  templateUrl: './profileanswesguestmchatr.page.html',
  styleUrls: ['./profileanswesguestmchatr.page.scss'],
})
export class ProfileanswesguestmchatrPage implements OnInit {
  childrenlist = [];
  txtbirthYear: null;
  txtRelation = "";
  txtgender = null;
  ...
  Ketqua() {
    ...
    this.router.navigate(['/ketquamchatrguest'], navigationExtras);
  }
