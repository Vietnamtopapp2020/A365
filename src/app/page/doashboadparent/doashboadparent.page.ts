...
@Component({
  selector: 'app-doashboadparent',
  templateUrl: './doashboadparent.page.html',
  styleUrls: ['./doashboadparent.page.scss'],
})
export class DoashboadparentPage {
  dc = [
    ...
    if (!data.checkSelect) {
      ...
      if (this.checkModal) {
        ...
        const myModal = await this.modalCtrl.create({
          component: DashbpadparentP2Page,
          componentProps: {
