...
ChartComponent.ɵfac = function ChartComponent_Factory(t) { return new (t || ChartComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(HighchartsService_1.HighchartsService)); };
ChartComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ChartComponent, selectors: [["chart"]], contentQueries: function ChartComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, ChartSeriesComponent_1.ChartSeriesComponent, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, ChartXAxisComponent_1.ChartXAxisComponent, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, ChartYAxisComponent_1.ChartYAxisComponent, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.series = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.xAxis = _t.first);
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.yAxis = _t.first);
    } }, inputs: { type: "type", options: "options" }, outputs: { create: "create", click: "click", addSeries: "addSeries", afterPrint: "afterPrint", beforePrint: "beforePrint", drilldown: "drilldown", drillup: "drillup", load: "load", redraw: "redraw", selection: "selection" }, features: [ɵngcc0.ɵɵProvidersFeature([HighchartsService_1.HighchartsService])], decls: 1, vars: 0, template: function ChartComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\u00A0");
    } }, encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ChartComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: HighchartsService_1.HighchartsService }]; }, { create: [{
            type: core_1.Output
        }], click: [{
            type: core_1.Output
        }], addSeries: [{
...
ChartComponent = __decorate([ __metadata("design:paramtypes", [core_1.ElementRef, HighchartsService_1.HighchartsService])
], ChartComponent);
